...
export abstract class CarouselPageDialogModel {
    description: string;
    actionText: string;
...
export class DialogLocked extends CarouselPageDialogModel {
...
export class DialogWIP extends CarouselPageDialogModel {
    constructor(dialogIMetaData: DialogIMetaData) {
        super(dialogIMetaData);
    }
...
export class DialogDone extends CarouselPageDialogModel {
