...
class MedicalExaminationState {
  ...
  MedicalExaminationState copyWith({
    bool? isMinusEnabled,
    bool? isPlusEnabled,
    int? count,
  }) {
    return MedicalExaminationState(
...
class MedicalExaminationViewModel extends ViewModel {

  final _stateSubject = BehaviorSubject<MedicalExaminationState>.seeded(MedicalExaminationState());
  Stream<MedicalExaminationState> get state => _stateSubject;
